...
*/
console.log('task 1a', createMenuItem('sandwich', 5, 'Lunch'));
...
const burger = {
  ...
  discount(string){
    if(string === 'teacher' || string === 'student'){
      return this.price = 18 * 0.75
    }else if(string === 'public'){
      return this.price = 18 * 0.9
    }
  }
...
// it keeps showing up as undefined
